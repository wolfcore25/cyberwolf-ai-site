    ...
    <nav className="fixed top-0 w-full z-50 bg-black/80 backdrop-blur-md border-b border-[var(--cyber-border)]">
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <span className="text-[var(--cyber-orange)] font-bold text-xl tracking-tight">
            CYBERWOLF
          </span>
          <span className="text-gray-500 text-sm font-light">AI SYSTEMS</span>
        </div>
        <div className="hidden md:flex items-center gap-8 text-sm text-gray-400">
          <a href="#services" className="hover:text-[var(--cyber-orange)] transition-colors">Services</a>
          <a href="#how-we-work" className="hover:text-[var(--cyber-orange)] transition-colors">How We Work</a>
          <a href="#portfolio" className="hover:text-[var(--cyber-orange)] transition-colors">Portfolio</a>
          <a href="#about" className="hover:text-[var(--cyber-orange)] transition-colors">About</a>
          <a
            href="#contact"
            className="px-4 py-2 bg-[var(--cyber-orange)] text-black font-semibold rounded hover:bg-[var(--cyber-orange-dim)] transition-colors"
          >
            Get Started
          </a>
        </div>
...
function Hero() {
  return (
    <section className="grid-bg min-h-screen flex items-center justify-center relative overflow-hidden">
      {/* Radial glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[var(--cyber-orange)] rounded-full opacity-[0.04] blur-[120px]" />

      <div className="max-w-4xl mx-auto px-6 text-center relative z-10 pt-20">
        <div className="inline-block px-4 py-1 border border-[var(--cyber-orange)]/30 rounded-full text-[var(--cyber-orange)] text-xs tracking-widest uppercase mb-8">
          Production AI Agent Development
        </div>

        <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6">
          <span className="text-white">Cyber</span>
          <span className="text-[var(--cyber-orange)] glow-text">Wolf</span>
          <br />
          <span className="text-gray-500 text-3xl md:text-4xl font-light">
            AI Systems
          </span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            href="#contact"
            className="px-8 py-3 bg-[var(--cyber-orange)] text-black font-bold rounded glow-orange hover:bg-[var(--cyber-orange-dim)] transition-all"
          >
            Start Your Project →
          </a>
          <a
            href="#services"
            className="px-8 py-3 border border-gray-700 text-gray-300 rounded hover:border-[var(--cyber-orange)]/50 hover:text-white transition-all"
          >
            View Services
          </a>
        </div>
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            What We <span className="text-[var(--cyber-orange)]">Build</span>
          </h2>
  ...
  return (
    <section id="how-we-work" className="py-24 px-6 bg-[var(--cyber-dark)]">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-4">
          How We <span className="text-[var(--cyber-orange)]">Work</span>
        </h2>
        ...
        <div className="border-glow rounded-xl p-8 md:p-12 bg-[var(--cyber-gray)]">
          <p className="text-2xl md:text-3xl font-bold text-white mb-6">
            We build on <span className="text-[var(--cyber-orange)]">YOUR</span>{" "}
            accounts.
            <br />
            You own <span className="text-[var(--cyber-orange)]">everything</span>.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-6 text-left">
            {[
              ...
              <div key={item.step}>
                <div className="text-[var(--cyber-orange)] font-mono text-sm mb-2">
                  {item.step}
                </div>
  ...
  return (
    <section id="portfolio" className="py-24 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Recent <span className="text-[var(--cyber-orange)]">Work</span>
          </h2>
          <div className="gradient-line max-w-xs mx-auto" />
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            >
              ...
              <div className="p-6">
                <span className="text-xs text-[var(--cyber-orange)] font-mono uppercase tracking-wider">
                  {p.tag}
                </span>
    ...
    <section id="about" className="py-24 px-6 bg-[var(--cyber-dark)]">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            About the <span className="text-[var(--cyber-orange)]">Founder</span>
          </h2>
          <div className="gradient-line max-w-xs mx-auto" />
        </div>
        ...
        <div className="border-glow rounded-xl p-8 md:p-12 bg-[var(--cyber-gray)] text-center">
          {/* Avatar placeholder */}
          <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[var(--cyber-orange)] to-[var(--cyber-orange-dim)] mx-auto mb-6 flex items-center justify-center text-3xl font-bold text-black">
            GS
          </div>
          <h3 className="text-2xl font-bold mb-2">Greg Schwartz</h3>
          <p className="text-[var(--cyber-orange)] text-sm font-mono mb-6">
            Founder & AI Engineer
          </p>
...
function Contact() {
  return (
    <section id="contact" className="py-24 px-6">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-4">
          Let&apos;s <span className="text-[var(--cyber-orange)]">Build</span>
        </h2>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          {[
            ...
            >
              <div className="text-xs text-[var(--cyber-orange)] font-mono uppercase tracking-wider mb-2">
                {c.label}
              </div>
    ...
    <footer className="border-t border-[var(--cyber-border)] py-8 px-6">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-600">
        ...
        <div className="flex gap-6">
          <Link href="/privacy" className="hover:text-[var(--cyber-orange)] transition-colors">
            Privacy Policy
          </Link>
          <Link href="/terms" className="hover:text-[var(--cyber-orange)] transition-colors">
            Terms of Service
          </Link>
        </div>
      </div>
